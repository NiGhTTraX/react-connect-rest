...
import HttpRestClient, { PostPayload, PatchPayload, DeletePayload, RestModel } from './lib/http-rest-client';

export default connectToRest;

export {
  RestStore, IRestStore, StoreModel,
  HttpRestClient, PostPayload, PatchPayload, DeletePayload, RestModel,
  RestStoreMock
};
